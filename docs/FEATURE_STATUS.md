...
| [REQ-006](../requirements/006-repository-onboarding-deck.md) | Repository onboarding deck | Documentation      | `design-review` | Pending        | Codex      | PR #11; Stitch screen `38d25ced2eca46f9a249ca658e5672c0`; six-frame HTML/PNG evidence | Obtain explicit approval for the generic Stitch storyboard before updating the HTML deck. |
