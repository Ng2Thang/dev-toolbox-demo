...
| [REQ-006](../requirements/006-base64-encoder-decoder.md)   | Base64 Encoder / Decoder   | `/tools/base64`    | `implementing`  | 2026-08-26     | Codex      | 90 Vitest tests; format, lint, typecheck, and build pass | Formatting blocker resolved; create pull request and validate its Vercel Preview. |
