...
| ----------------------------------------------------------------- | --------------------------------- | ---------------------- | --------------- | -------------- | ---------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [REQ-001](../requirements/001-toolbox-home.md)                    | Toolbox Home and Discovery        | `/`                    | `design-review` | Pending        | Unassigned | ?                                                                                                   | Export the referenced Stitch evidence, register it in metadata, then obtain explicit UI approval.                  |
...
| [REQ-005](../requirements/005-uuid-generator.md)                  | UUID Generator                    | `/tools/uuid`          | `delivered`     | 2026-08-23     | Codex      | PR #9; 75 tests; preview Ready                                                                      | Preview is SSO-gated; Vercel build and deployment status validated.                                                |
| [REQ-006](../requirements/006-base64-encoder-decoder.md)          | Base64 Encoder / Decoder          | `/tools/base64`        | `delivered`     | 2026-08-26     | Codex      | PR #12; 90 Vitest tests; `npm run check`; Vercel Preview Ready (`dpl_D68xX1gSCyi1hhv5ogmtcP7ZBSti`) | Preview route returned HTTP 200 and rendered the Base64 workspace.                                                 |
| [REQ-007](../requirements/007-lorem-ipsum-mock-data-generator.md) | Lorem Ipsum / Mock Data Generator | `/tools/mock-data`     | `delivered`     | 2026-08-26     | Codex      | PR #13; 105 Vitest tests; 39 Playwright tests; Preview Ready (`dpl_hEgdFBFZSLSugLUU2TMhGBJVFn8K`)   | Preview route returned HTTP 200 with the generator workspace; repository-wide Prettier exception is unrelated.     |
| [REQ-008](../requirements/008-sql-formatter.md)                   | SQL Formatter                     | `/tools/sql-formatter` | `blocked`       | 2026-08-26     | Codex      | Branch pushed; commit `c3af0f9`; 121 Vitest tests; 46 Playwright tests; production build passed     | Refresh GitHub write authentication after PR creation returned HTTP 403, then create PR and validate Preview.      |
