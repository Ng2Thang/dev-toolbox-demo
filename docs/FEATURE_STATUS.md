...
| [REQ-006](../requirements/006-base64-encoder-decoder.md)   | Base64 Encoder / Decoder   | `/tools/base64`    | `blocked`       | 2026-08-26     | Codex      | PR #12; 90 Vitest tests; format, lint, typecheck, and build pass | Vercel Preview is blocked: Git deployments are disabled and the configured CLI token is invalid. |
