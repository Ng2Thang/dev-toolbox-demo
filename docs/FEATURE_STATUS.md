...
| [REQ-006](../requirements/006-base64-encoder-decoder.md)   | Base64 Encoder / Decoder   | `/tools/base64`    | `blocked`       | 2026-08-26     | Codex      | Commits `030b04b`, `e49ea66`; 90 Vitest tests | `npm run check` is blocked by 67 pre-existing formatting violations outside REQ-006; PR and preview remain pending. |
