...
| [REQ-006](../requirements/006-repository-onboarding-deck.md) | Repository onboarding deck | Documentation      | `blocked`       | Not applicable | Codex      | 75 tests; lint/types/build passed under Node 24.14.0 | Clear the pre-existing 69-file Prettier baseline so `npm run check` can pass.                         |
