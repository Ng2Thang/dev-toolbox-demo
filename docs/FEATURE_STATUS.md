...
| [REQ-006](../requirements/006-repository-onboarding-deck.md) | Repository onboarding deck | Documentation      | `blocked`       | Not applicable | Codex      | Story refactor `0426b41`; Chromium passed; 75 tests; lint/types/build passed under Node 24.14.0 | Clear the pre-existing 69-file Prettier baseline and refresh GitHub CLI authentication to create the PR. |
