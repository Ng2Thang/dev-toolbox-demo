...
| [REQ-008](../requirements/008-sql-formatter.md)                   | SQL Formatter                     | `/tools/sql-formatter` | `implementing`  | 2026-08-26     | Codex      | Approved Stitch screen `38f5d84f78d24f54a405c361446bb770`; HTML/PNG exported                        | Implement browser-local formatting and validation, tests, PR, and Preview evidence.                                |
