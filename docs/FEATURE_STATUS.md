...
| [REQ-002](../requirements/002-jwt-decoder.md)              | JWT Decoder                | `/tools/jwt`       | `design-review` | Pending        | Unassigned | ?                 | Obtain explicit approval for Stitch screen `a77dc8152e854a5aafa4f9d9827b715c`. |
