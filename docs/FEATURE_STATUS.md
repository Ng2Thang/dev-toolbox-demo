...
| [REQ-008](../requirements/008-sql-formatter.md)                   | SQL Formatter                     | `/tools/sql-formatter` | `implementing`  | 2026-08-26     | Codex      | Commit `c3af0f9`; 121 Vitest tests; 46 Playwright tests; production build passed                    | Create the template-backed PR and validate a Vercel Preview; aggregate check has unrelated Prettier failures.      |
